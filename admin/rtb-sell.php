        ...
        try {
            switch ($_POST['action']) {
                case 'create':
                    ...
                    $success = 'RTB campaign created successfully!';
                    break;
                ...
                case 'delete':
                    $campaign_id = (int)$_POST['campaign_id'];
                    $db->delete('rtb_campaigns', 'id = ?', [$campaign_id]);
...
<!-- Create New RTB Campaign -->
<div class="row mb-4">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-plus"></i> Create New RTB Campaign</h5>
            </div>
            <div class="card-body">
                <form method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="url" class="form-control" id="endpoint_url" name="endpoint_url" 
                                   placeholder="https://example.com/rtb/endpoint" required>
                            <div class="form-text">The RTB endpoint URL where bid requests will be sent</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-text">Leave empty for all countries</div>
                        </div>
                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Create RTB Campaign
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="card-body">
                <?php if (empty($campaigns)): ?>
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted">No RTB campaigns found</h5>
                        <p class="text-muted">Create your first RTB campaign to start selling traffic through real-time bidding.</p>
                    </div>
                <?php else: ?>
                                ...
                                <?php foreach ($campaigns as $campaign): ?>
                                    <tr>
                                        <td>
                                            ...
                                            <br>
                                            <small class="text-muted"><?php echo htmlspecialchars(substr($campaign['endpoint_url'], 0, 50)); ?>...</small>
                                        </td>
