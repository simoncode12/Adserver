...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Admin Dashboard'; ?> - AdStart AdServer</title>
            ...
            <div class="col-md-2 px-0">
                <div class="sidebar">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'ssp_endpoints.php' ? 'active' : ''; ?>" href="ssp_endpoints.php">
                            <i class="fas fa-server"></i>SSP Endpoints
                        </a>
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'categories.php' ? 'active' : ''; ?>" href="categories.php">
                            <i class="fas fa-tags"></i>Categories
                        </a>
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'banner_sizes.php' ? 'active' : ''; ?>" href="banner_sizes.php">
                            <i class="fas fa-expand-arrows-alt"></i>Banner Sizes
                        </a>
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'ad_formats.php' ? 'active' : ''; ?>" href="ad_formats.php">
                            <i class="fas fa-palette"></i>Ad Formats
                        </a>
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'blacklist.php' ? 'active' : ''; ?>" href="blacklist.php">
                            <i class="fas fa-ban"></i>Blacklist
                        </a>
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'anti_fraud.php' ? 'active' : ''; ?>" href="anti_fraud.php">
                            <i class="fas fa-shield-virus"></i>Anti-Fraud
                        </a>
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'rtb_debug.php' ? 'active' : ''; ?>" href="rtb_debug.php">
                            <i class="fas fa-bug"></i>RTB Debug
                        </a>
